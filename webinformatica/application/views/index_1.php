...
<html lang="en">
    <head>
        ...
        <script src="<?= base_url() . 'js/Open_Sans_400.font.js';?>" type="text/javascript"></script>
        <script src="<?= base_url() . 'js/Open_Sans_italic_400.font.js';?> type="text/javascript"></script> 
