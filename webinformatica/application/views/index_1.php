...
<html lang="en">
    <head>
        <title></title>
        <meta charset="utf-8">
        <link rel="stylesheet" href="application/css/reset.css" type="text/css" media="screen">
        <link rel="stylesheet" href="application/css/style.css" type="text/css" media="screen">
        <link rel="stylesheet" href="application/css/grid.css" type="text/css" media="screen">   
